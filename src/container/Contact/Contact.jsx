...
const Contact = () => {
	...
	let socialMedia = [
		{ name: 'Email', icon: <HiMail />, link: 'mailto: ivandjuka777@gmail.com' },
		{
			name: 'AngelList',
			icon: <FaAngellist />,
			link: 'https://angel.co/u/ivan-djukic-1',
		},
		{
			name: 'Github',
			icon: <FaGithub />,
			link: 'https://github.com/ivandjuka77',
		},
		{
			name: 'LinkedIn',
			icon: <FaLinkedinIn />,
			link: 'https://www.linkedin.com/in/ivan-djukic-786460248',
		},
		{
			name: 'Twitter',
			icon: <FaTwitter />,
			link: 'https://twitter.com/ivandjukic02',
		},
	];
		...
		<div id='contact'>
			<div className='contact-left'>
				...
				<span className='contact-name'>
					© Ivan Djukic. All rights reserved.
				</span>
			</div>
