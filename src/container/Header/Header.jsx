  ...
  return (
    <div id='home'>
        <div className='header-left'>
            ...
            >
                <img src={headshot} alt='headshot' className='header-headshot'/>
            </motion.div>
            <motion.div
        ...
        <div className='header-right'>
            <motion.h1 
                ...
                animate={{ opacity: 1, x: 0, transition: { duration: 1.2, delay: 0.6 } }}>Welcome to my personal website! <br/>
